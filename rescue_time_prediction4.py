    ...
    <div class="container">
        ...
        <p class="logo-text">
            <font color=#6e6e6e>
                ...
                to the Arrival Time Estimator<br>dedicated to the London Fire Brigade.
                    <br>
                    <br>
                This tools will help you to predict<br>the estimated time of arrival of the LFB,
                    <br>
                based on the factors chosen.<br><br><b>Please select your settings</b>
        </p>
    </div>
    """,
    unsafe_allow_html=True
...
def add_parameter_ui(clf_name):
    ...
    if clf_name =="LinearRegression":
        n_jobs = st.sidebar.slider("n_jobs",10,500,250)
        params["n_jobs"] = n_jobs
    elif clf_name == "RandomForestRegressor":
        n_estimators = st.sidebar.slider("n_estimators",10,5000,2500)
